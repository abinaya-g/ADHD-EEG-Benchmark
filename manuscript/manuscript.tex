...
\item \textbf{Commit}: \texttt{PENDING\_FINAL\_COMMIT\_HASH} (the commit that froze this manuscript revision together with \texttt{results\_final/predictions/all\_predictions.csv} and \texttt{manuscript/TABLES/})
