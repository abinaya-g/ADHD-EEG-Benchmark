...
5. No numerical value in the manuscript was found to be copied or adapted from the original, desk-rejected manuscript's own reported numbers; all Results-section figures are original computations from this project's own re-run pipeline.

**Overall status: PASS.** Two discrepancies were found and corrected across the two audit passes recorded in this report (items 1 and 3); no other discrepancy was found across the 24 checked items. This report should still be re-run once more, mechanically, immediately before submission, since it was produced by manual audit passes rather than an automated CI-integrated check.
